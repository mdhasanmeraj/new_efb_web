...
urlpatterns = [
    ...
    path('privacy-cookies-policy/', views.privacy_cookies_policy, name='privacy_cookies_policy'),
    path('disclaimer/', views.disclaimer, name='disclaimer'),
    path('bdp-terms-and-conditions/', views.bdp_terms_and_conditions, name='bdp_terms_and_conditions'),
    path('bdp-privacy-policy/', views.bdp_privacy_policy, name='bdp_privacy_policy'),
